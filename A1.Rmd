...
knitr::kable(tb_grouped, format="simple", caption="Summary of Australia vs Japan Population Growth")
```
...
* Japan's median age becam higher compared to Australia from the mid 1960's  
